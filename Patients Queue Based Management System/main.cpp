...
public:
	...
	Treating(Patient* patient) {
		...
		this->medicine3 = "";
		this->sickness ="";
		this->treatingDate = getCurrentDate();
		this->treatingTime = getCurrentTime();
	}

	void setMedicine1(string medicine) {
		this->medicine1 = medicine;
	}

	void setMedicine2(string medicine) {
		this->medicine2 = medicine;
	}

	void setMedicine3(string medicine) {
...
class TreatingNode {
public:
	Treating* currentTreating;
	TreatingNode* previousNode;
	TreatingNode* nextNode;
};

class TreatingLinkedList {
...
public:
	...
	void appendTreating(Treating* treating) {

		TreatingNode* newNode = new TreatingNode();
		newNode->currentTreating = treating;
		newNode->nextNode = NULL;
		newNode->previousNode = tail;
		tail = newNode;
	...
	int checkExistence(string patientID) {
		...
		int index = 0;
		TreatingNode* last = head;

		while (last != NULL) {
			if (last->currentTreating->patient->UserID == patientID)
			{
				return index;
			}
			else
	...
	void medicine1SetAt(int index, string medicine) {
		...
		last->currentTreating->medicine1 = medicine;
	}

	void medicine2SetAt(int index, string medicine) {
		...
		last->currentTreating->medicine2 = medicine;
	}

	void medicine3SetAt(int index, string medicine) {
		...
		last->currentTreating->medicine3 = medicine;
	}

	void display(TreatingLinkedList* TreatingList) {
		...
		{
			TreatingNode* temp = head;
			while (temp != NULL) {
				cout << "\033[1;33m---------------------------------------------------------------\n";
				cout << "\n";

				cout << "\033[1;33mPatient ID: \033[0m" << temp->currentTreating->patient->UserID << "\n";
				cout << "\033[1;33mFirst Name: \033[0m" << temp->currentTreating->patient->firstName << "\n";
				cout << "\033[1;33mLast Name: \033[0m" << temp->currentTreating->patient->lastName << "\n";
				cout << "\033[1;33mGender: \033[0m" << temp->currentTreating->patient->gender << "\n";
				cout << "\033[1;33mAge: \033[0m" << temp->currentTreating->patient->age << "\n";
				cout << "\033[1;33mPhone Number: \033[0m" << temp->currentTreating->patient->phone << "\n";
				cout << "\033[1;33mAddress: \033[0m" << temp->currentTreating->patient->address << "\n";
				cout << "\033[1;33mDisability Option: \033[0m" << temp->currentTreating->patient->disability << "\n";
				cout << "\033[1;33mPriority: \033[0m" << temp->currentTreating->patient->priority << "\n";
				cout << "\033[1;33mVisit Date: \033[0m" << temp->currentTreating->treatingDate << "\n";
				cout << "\033[1;33mVisit Time: \033[0m" << temp->currentTreating->treatingTime << "\n";
				cout << "\n";
